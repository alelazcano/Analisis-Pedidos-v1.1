...
docker run -d -p 7071:3306 -v /home/MTTO-TIENDA/Analisis-Pedidos/bbdd:/var/lib/mysql -e MYSQL_ROOT_PASSWORD=vmsn2004 --name analisis-pedidos-bbdd -h db-analisispedidos mysql:5.7
